...
This is a class I borrowed. All it does is pre-defines a wide variety 
of colours, so that I can use them anytime without having to search for 
and enter RGB values.
"""
