...
class Kim_Sprites:
    ...
    Kim = pygame.transform.scale(Kim, (int(21*scale_factor),int(52*scale_factor))) # Scaling (enlarging) the sprite.
    ...
    Kim = pygame.transform.scale(Kim, (int(22*scale_factor),int(52*scale_factor)))
    stand2 = Kim
    ...
    Kim = pygame.transform.scale(Kim, (int(21*scale_factor),int(52*scale_factor)))
    stand10 = Kim
    ...
    Kim = pygame.transform.scale(Kim, (int(20*scale_factor),int(52*scale_factor)))
    stand12 = Kim
